---
name: web-editor
description: Next.js editor - MapLibre picker, preset row, r3f instanced preview, parameter panel, export flow, stats card
...
table; the Preview flow (POST /scene) and the Export flow (POST /bake, poll
...
client-side 2D dilation so the preview approximates the build's minimum-feature
